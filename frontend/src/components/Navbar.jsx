    ...
    return (
        <div className={`navbar-intensive ${scrolled ? 'scrolled' : ''}`}>
            <div data-collapse="medium" data-animation="default" data-duration="400" data-doc-height="1"
                ...
                <div className={`container-28 intensive-2-0 w-container ${isAdminPage ? 'admin-nav-container' : ''}`}>
                    <a href="/landing.html" className={`brand-9 w-nav-brand ${isAdminPage ? 'admin-nav-brand' : ''}`}>
